...
const beforeAfterProjects = [
  {
    ...
    beforeImage: "/assets/images/jasa-renovasi-rumah/before1.jpg",
    afterImage: "/assets/images/jasa-renovasi-rumah/after1.jpg",
  },
  {
    id: 2,
    ...
    beforeImage: "/assets/images/jasa-renovasi-rumah/before2.jpg",
    afterImage: "/assets/images/jasa-renovasi-rumah/after2.jpg",
  },
  {
    id: 3,
    ...
    beforeImage: "/assets/images/jasa-renovasi-rumah/before3.jpg",
    afterImage: "/assets/images/jasa-renovasi-rumah/after3.jpg",
  }
];
          ...
          <div className="hidden md:flex justify-center gap-2 mt-6">
            {beforeAfterProjects.map((_, idx) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${activeIndex === idx ? 'w-8 bg-primary' : 'w-2 bg-on-surface/20'
                  }`}
          ...
          <div className="flex md:hidden justify-center gap-2 mt-8">
            {beforeAfterProjects.map((_, idx) => (
              <button
                key={`bottom-dot-${idx}`}
                onClick={() => setActiveIndex(idx)}
                className={`h-2.5 rounded-full transition-all duration-300 ${activeIndex === idx ? 'w-8 bg-primary' : 'w-2.5 bg-on-surface/20'
                  }`}
                aria-label={`Go to slide ${idx + 1}`}
              />
            ))}
