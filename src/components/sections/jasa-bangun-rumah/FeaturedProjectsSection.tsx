      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {featuredProjects.map((project) => (
            <div key={project.id} className="group rounded-2xl overflow-hidden shadow-lg border border-on-surface/5 bg-background ambient-shadow-1 hover:-translate-y-2 transition-all duration-500">
