        ...
        {featuredProjects.map((project, idx) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 flex flex-col justify-end translate-y-2 md:translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
              ...
              <p className="text-white/80 font-body text-sm md:text-base mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200 line-clamp-2 md:line-clamp-3">
                {project.description}
              </p>
            </div>
          </div>
